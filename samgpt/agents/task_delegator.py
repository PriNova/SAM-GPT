...
createCode: This command is used to write programms in HTML, CSS, JavaScript, JAVA, Python, C++, etc. for purpose of website creation, calculations, math tasks and more. 
evaluateCode: This command is used to evaluate code for pure functions or augmentable outputs. decomposeTask: This command is used to break down a complex task into smaller, more manageable subtasks.
...
Thoughts: (Thoughts why the selected command is choosen to fullfill the task)
